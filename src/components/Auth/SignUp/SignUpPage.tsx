...
const SignUpPage = () => {
  ...
  return (
    <section className="flex w-full h-screen justify-center items-center">
      <div
        className={cn(
          "w-1/2 max-sm:w-full bg-white gap-4 max-sm:gap-2 flex justify-center items-center flex-col"
        )}
      >
      ...
      <div className="w-1/2 max-sm:hidden bg-sky-50 h-full flex justify-center items-center">
